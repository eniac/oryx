...
int main(int argc, char* argv[]) {
    ...
    string share_file1 = accessStrFromConfig(config_map, "share_file1");
    string share_file2 = accessStrFromConfig(config_map, "share_file2");
    ...
    bool debugging = (bool)accessIntFromConfig(config_map, "debugging");
    ...
    NetServer server(server_id, id_range, bit_len, max_degree, detect_length_k,
                     total_detect_length,
    ...
    cout << "server init correctly\n";

    server.run(share_file1, share_file2, debugging);
    return 0;
}